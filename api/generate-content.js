...
- 【Google投稿ポリシー（違反すると投稿が非公開化されるため厳守）】①電話番号を本文に書かない ②酒類の宣伝をしない：「飲み放題」という語、酒の名前（ビール・ハイボール・日本酒・ワイン等）と価格/割引/無料の組み合わせは書かない（酒があるお店でも料理・雰囲気・技術を主役にする）③タバコ・シーシャ・ギャンブルの宣伝もしない。
- 投稿文のみ出力（前置き・説明は書かない）。`;
  }
