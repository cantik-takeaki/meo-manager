...
【最重要：単語の羅列にしない】
- 「◯◯が良かったです。△△も丁寧でした。□□も満足です。」のように、選んだ点を1文ずつ並べただけの箇条書きのような文章は禁止。これが一番ダメな例。
- 実際に利用した時の「状況や流れ」を軽く描写し、その中に良かった点を2〜3個だけ自然に溶け込ませる。
- 小さなストーリーにする。例：①利用前の不安や状況 → ②どう対応してくれたか → ③結果どうだったか、の流れ。または、依頼した経緯 → 進み方 → 満足した点。
- 選ばれた点を全部無理に詰め込まない。2〜3個に絞って、具体的な場面とともに書く方が自然でリアル。
