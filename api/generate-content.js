...
- 口コミ本文が日本語以外の言語の場合は、日本語の定型文ではなく【口コミと同じ言語】で、同等の構成（挨拶→お礼→本文の具体点への言及→今後の姿勢→締め）で自然に返信する。
- ${humanTone}
- ${symbolRule}
...
- 口コミ本文が日本語以外の言語の場合は、日本語の定型文ではなく【口コミと同じ言語】で、同等の構成（挨拶→お礼とお詫び→指摘点への誠実な言及→改善姿勢→締め）で自然に返信する。
